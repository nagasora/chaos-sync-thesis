...
2026-09-06: [TM-Aの力学適合性実験](experiments/E1/TM_DYNAMICS.md)を追加。角度Fourierとの同値性と有限16次元の打切りを168軌道で確認し、独立396チェック通過。基底の疎性と予測可能性を分離し、TM-B/E1・TM-C/E3の方針を具体化した。
...
研究目標・最新結果・理論の導出・次の実験手順は、[研究・実験ノート](docs/RESEARCH_NOTEBOOK.md)に整理しています（2026-09-06）。
